...
export default function App() {
  ...
  const t = {
    ko: {
      nav: { profile: "프로필", impact: "성과", stack: "기술", projects: "프로젝트", career: "경력", contact: "연락하기" },
      hero: {
        badge: "성능 최적화 전문가",
        title1: "55만 유저의",
        ...
        coverLetter: "자기소개서",
        summaryTitle: "전문가 요약",
        summaryDesc: "\"최고의 공부는 실전이다\"라는 신념 아래, Cursor 및 MCP 등 차세대 AI 도구를 활용한 워크플로우 혁신으로 Swift 네이티브 프레임워크를 단기 습득하여 하드웨어 진단 로직을 구현하는 등 플랫폼의 경계를 넘나드는 압도적 생산성을 증명합니다.",
      ...
      tech: {
        title: "핵심 기술 스택",
        desc: "프론트엔드 코어 기술부터 네이티브 연동, 인프라, AI 생산성 도구까지 플랫폼의 한계를 넘나드는 기술 스택을 보유하고 있습니다.",
        cat1: "프론트엔드 & 상태관리",
        cat2: "네이티브 & 인프라",
        cat3: "AI & 생산성",
        cat4: "특화 기술"
      ...
      mindset: {
        title: "Work Ethic",
        m1Title: "사용자 중심의 사고",
        m1Desc: "단순한 기능 구현을 넘어, 실제 사용자가 겪는 불편함을 데이터와 피드백으로 분석하여 최적의 UX를 설계합니다.",
        m2Title: "지속 가능한 코드",
        m2Desc: "팀원 누구나 이해할 수 있는 클린 코드를 지향하며, 유지보수가 용이하고 확장성 있는 아키텍처를 고민합니다.",
        m3Title: "능동적인 문제 해결",
        m3Desc: "기술적 한계에 부딪혔을 때 포기하지 않고, 다양한 대안을 제시하며 비즈니스 목표 달성을 위한 최선의 경로를 찾습니다.",
        m4Title: "철저한 서비스 안정성",
        m4Desc: "장애 발생 가능성을 사전에 차단하기 위해 꼼꼼한 테스트와 모니터링을 생활화하며, 안정적인 서비스 운영을 최우선으로 합니다."
      },
      career: {
        title: "경력",
        edu: "학력 및 기타",
        connecti: "55만 유저 규모의 '열달후에' 서비스 개발 및 성능 최적화 주도",
        biskit: "IoT 서비스 연동 및 어드민 시스템 구축, 프론트엔드 아키텍처 설계",
        univ: "글로벌 비즈니스학과 졸업",
        exchange: "대만 Ming Chuan University 교환학생 (1년) - 글로벌 비즈니스 마인드셋 함양",
        extraTitle: "성실성 및 책임감 증명",
        extraDesc: "30사단 훈련소 훈련 성적 전체 2등(500명 중) 수료 및 사단장 표창 수여. 어떠한 환경에서도 최선의 결과를 만들어내는 끈기를 보유하고 있습니다.",
    ...
    en: {
      nav: { profile: "Profile", impact: "Impact", stack: "Stack", projects: "Projects", career: "Career", contact: "Contact" },
      hero: {
        ...
        summaryDesc: "With a 'learning by doing' mindset, I demonstrate overwhelming productivity across platforms—such as quickly mastering Swift to implement hardware diagnostics through AI-driven workflow innovations like Cursor and MCP.",
      ...
      mindset: {
        ...
        m1Desc: "Beyond simple implementation, I analyze user pain points with data and feedback to design the optimal UX.",
        m2Title: "Sustainable Code",
        m2Desc: "I aim for clean code that any team member can understand, focusing on maintainable and scalable architecture.",
        m3Title: "Proactive Problem Solving",
        m3Desc: "I don't give up when facing technical limits; I propose various alternatives to find the best path for business goals.",
        m4Title: "Uncompromising Stability",
        m4Desc: "I prioritize stable service operation by making thorough testing and monitoring a habit to prevent potential failures."
      },
      career: {
        title: "Career",
        edu: "Education & More",
        connecti: "Leading development and optimization for 'Yeoldal' (550K users)",
        biskit: "IoT service integration, admin systems, and frontend architecture design",
        univ: "B.A. in Global Business",
        exchange: "Exchange student at Ming Chuan University, Taiwan (1 year)",
        extraTitle: "Diligence & Responsibility",
        extraDesc: "Ranked 2nd out of 500 at the 30th Division Training Center. I possess the persistence to achieve best results in any environment.",
  ...
  const projects = [
    {
      ...
      category: "App",
      subtitle: lang === "ko" ? "임신·출산·육아 통합 관리 앱 (가입자 55만)" : "Pregnancy & Parenting App (550K Users)",
      ...
      achievements: lang === "ko" ? [
        "최신 OS 대응: Android 15 16KB 페이지 사이즈 메모리 이슈 선제적 분석 및 해결",
        "UI 안정성 강화: Reanimated 기반 신규 컴포넌트로 헤더 깜빡임(Glitch) 현상 제거",
        "차트 렌더링 최적화: ScrollView 기반 커스텀 차트 설계로 네이티브 수준 스크롤 구현",
        "아키텍처 개선: 클래스형 컴포넌트의 함수형(Hooks) 전면 리팩토링으로 기술 부채 절감"
      ] : [
        "OS Adaptation: Proactive analysis and resolution of Android 15 16KB page size memory issues",
        "UI Stability: Eliminated header glitches using new Reanimated-based components",
        "Chart Optimization: Designed custom ScrollView-based charts for native-level scrolling",
        "Architecture: Full refactoring from Class to Functional components (Hooks)"
      ],
    ...
    },
    {
      ...
      category: "App",
      subtitle: lang === "ko" ? "반려동물 IoT 서비스 전용 앱 (Biskit IoT 통합)" : "Pet IoT Service App (Biskit IoT Integration)",
      tags: ["React Native", "WebSocket", "Bluetooth", "Atomic Design"],
      ...
      achievements: lang === "ko" ? [
        ...
        "UX 퍼포먼스: Reanimated 기반 인터랙션 최적화로 렌더링 성능 향상 (40fps → 60fps 달성)",
        "생산성 향상: Atomic Design 시스템 도입 및 컴포넌트 추상화로 개발 공수 20% 절감"
      ] : [
        "Stability: Improved crash rate from 3.89% to 0.02% via Crashlytics tracking",
        "Real-time: Built WebSocket-based device sync and push notification systems",
        "UX Performance: Optimized interactions with Reanimated (40fps → 60fps)",
        "Productivity: Reduced dev effort by 20% through Atomic Design & abstraction"
      ],
    ...
    },
    {
      ...
      category: "Web",
      subtitle: lang === "ko" ? "IoT 서비스 통합 관리 시스템 (Biskit Admin 통합)" : "Pet IoT Integrated Admin System",
      tags: ["React", "MUI DataGrid", "RBAC", "Axios Interceptor"],
      images: [
      ...
      achievements: lang === "ko" ? [
        "운영 효율화: RBAC(역할 기반 권한 제어) 시스템 구축으로 QA 통과율 및 운영 효율 100% 달성",
        "통합 보안 인증: Axios Interceptor 기반 JWT 인증 로직 전역화 및 소셜 로그인 추상화",
        "데이터 시각화: 대규모 기기 상태 및 사용자 케어 데이터를 실시간 그리드와 차트로 구현",
        "운영 자동화: 엑셀 커스텀 연동 기능 및 대량 데이터 처리 로직 구축으로 운영 시간 단축"
      ] : [
        "Ops Efficiency: 100% QA pass rate achieved via RBAC system implementation",
        "Security: Globalized JWT logic with Axios Interceptors & social login abstraction",
        "Visualization: Real-time grids and charts for large-scale device/user data",
        "Automation: Reduced ops time via custom Excel integration and mass data processing"
      ],
    ...
    {
      id: "findirect",
      title: lang === "ko" ? "핀다이렉트 중고폰 검사" : "Findirect Phone Check",
      category: "Native/PWA",
      subtitle: lang === "ko" ? "네이티브 진단 프레임워크 & PWA" : "Native Diagnostic Framework & PWA",
    ...
    {
      id: "wnms",
      title: lang === "ko" ? "WNMS (Wireless Network Management System)" : "WNMS (Wireless Network Management System)",
      category: "Web",
      subtitle: lang === "ko" ? "네트워크 장비(AP) 관제 대시보드 및 지도 기반 모니터링" : "Network Device (AP) Control Dashboard & Map-based Monitoring",
      ...
      achievements: lang === "ko" ? [
        "지도 기반 관제: Kakao Map API 연동 및 마커 커스터마이징으로 장비 위치·상태 시각화",
        "데이터 시각화: ECharts를 활용한 트래픽 통계 그래프 및 MUI DataGrid를 활용한 대용량 리스트 최적화",
        "보안 및 세션: Axios Interceptor와 sessionStorage를 결합한 안정적인 토큰 인증 체계 구축"
      ] : [
        "Geospatial Control: Visualized device status via Kakao Map API integration and custom markers",
        "Data Visualization: Implemented traffic stats via ECharts and optimized large lists using MUI DataGrid",
        "Security & Session: Built stable token authentication via Axios Interceptor and sessionStorage"
      ],
  ...
  const categories = ["All", "App", "Web", "Native/PWA"];
  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-primary selection:bg-brand-accent selection:text-white relative overflow-x-hidden">
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "glass py-3 shadow-sm" : "py-6"}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-brand-primary rounded-full flex items-center justify-center text-white font-bold text-xs">HW</div>
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-brand-secondary">
            <a href="#profile" className="hover:text-brand-primary transition-colors">{t.nav.profile}</a>
            <a href="#stats" className="hover:text-brand-primary transition-colors">{t.nav.impact}</a>
            <a href="#tech" className="hover:text-brand-primary transition-colors">{t.nav.stack}</a>
            <a href="#projects" className="hover:text-brand-primary transition-colors">{t.nav.projects}</a>
            <a href="#career" className="hover:text-brand-primary transition-colors">{t.nav.career}</a>
          </div>
      ...
      <main>
        ...
        <section id="profile" className="pt-32 pb-20 px-6 overflow-hidden">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <motion.div>
                <motion.div variants={fadeIn} className="inline-flex items-center gap-2 px-3 py-1 bg-brand-surface border border-brand-border rounded-full text-xs font-bold text-brand-accent mb-6">
                  <Zap size={14} />
                  <span>{t.hero.badge}</span>
                </motion.div>
                <motion.h1 variants={fadeIn} className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.95] mb-8 text-brand-primary">
                  {lang === 'ko' ? (
                    <>
                ...
                <motion.p variants={fadeIn} className="text-xl md:text-2xl text-brand-secondary max-w-2xl leading-relaxed mb-10 text-balance">
                  {t.hero.desc}
                </motion.p>
                ...
                <motion.div variants={fadeIn} className="flex flex-wrap gap-6 items-center">
                  ...
                  <div className="flex gap-4 items-center">
                    <a href="/resume.pdf" download className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider hover:text-brand-accent transition-colors">
                      <FileText size={16} />
                      <span>{t.hero.resume}</span>
                    </a>
                    <a href="/cover-letter.pdf" download className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider hover:text-brand-accent transition-colors">
                      <FileText size={16} />
                      <span>{t.hero.coverLetter}</span>
                    </a>
                  </div>
                  <div className="flex gap-4">
                    <a href="https://github.com" target="_blank" rel="noreferrer" className="p-2 border border-brand-border rounded-full hover:bg-brand-surface transition-colors">
                      <Github size={20} />
                    </a>
                    <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="p-2 border border-brand-border rounded-full hover:bg-brand-surface transition-colors">
                      <Linkedin size={20} />
                    </a>
                  </div>
                </motion.div>
              ...
              >
                <h3 className="text-xs font-bold uppercase tracking-widest text-brand-secondary mb-6">{t.hero.summaryTitle}</h3>
        ...
        {/* Stats Section */}
        <section id="stats" className="pt-12 pb-20 bg-brand-primary text-white overflow-hidden relative">
            ...
            >
              ...
              <motion.div variants={fadeIn}>
                <StatItem 
                  ...
                  value="-20%" 
                  subValue={lang === "ko" ? "코드량 슬림화" : "Code Slimming"} 
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <motion.div variants={fadeIn} className="md:w-1/3">
                <h2 className="text-4xl font-black tracking-tighter mb-6 uppercase">{t.tech.title}</h2>
              ...
              <div className="md:w-2/3 grid sm:grid-cols-2 gap-8">
                <motion.div variants={fadeIn}>
                  <TechCategory 
                    title={t.tech.cat1} 
                    icon={<Layers size={20} />}
                    items={["React Native", "React", "TypeScript", "PWA", "MobX", "Zustand", "TanStack Query"]}
                  />
                </motion.div>
                <motion.div variants={fadeIn}>
                  <TechCategory 
                    ...
                    items={["Swift 5.x", "Android Native Module", "Firebase", "AWS S3", "REST API", "WebSocket"]}
                  />
                </motion.div>
                <motion.div variants={fadeIn}>
                  <TechCategory 
                    ...
                    items={["Cursor", "MCP", "Claude", "Stitch AI", "Jira", "App Store Connect"]}
                  />
                </motion.div>
                <motion.div variants={fadeIn}>
                  <TechCategory 
                    ...
                    items={["Web Blob Handling", "Android 15 SDK 35 대응", "Atomic Design", "RBAC System"]}
                  />
                </motion.div>
              </div>
            </motion.div>
        ...
        {/* Projects Section */}
        <section id="projects" className="py-24 px-6 bg-brand-surface overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-12 gap-8 text-center md:text-left">
              <div className="flex flex-col items-center md:items-start">
                <h2 className="text-5xl font-black tracking-tighter uppercase mb-4">{t.projects.title}</h2>
            ...
            <div className="relative group">
              ...
              <div 
                ...
                className="flex gap-6 md:gap-8 overflow-x-auto pb-12 snap-x snap-mandatory no-scrollbar scroll-smooth cursor-grab active:cursor-grabbing select-none scroll-px-6 px-6 md:scroll-px-[10vw] md:px-[10vw]"
              >
                <AnimatePresence mode="popLayout">
                  {filteredProjects.map((project) => (
                    <motion.div
                      ...
                      className="min-w-[280px] w-[85vw] sm:w-auto sm:min-w-[450px] md:min-w-[550px] lg:min-w-[650px] snap-center"
                    >
                      <ProjectCard 
                        project={project} 
                        t={t.projects}
        ...
        {/* Work Ethic Section */}
        <section ref={workEthicRef} className="py-32 px-6 bg-brand-surface/30 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              <h2 className="text-5xl font-black tracking-tighter uppercase mb-4">{t.mindset.title}</h2>
            ...
            >
              ...
              <motion.div variants={fadeIn} className="h-full">
                <MindsetItem 
                  ...
                  title={t.mindset.m4Title}
                  desc={t.mindset.m4Desc}
                />
              </motion.div>
              <motion.div variants={fadeIn} className="h-full">
                <MindsetItem 
      ...
      <footer className="py-12 px-6 border-t border-brand-border text-center">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-6">
          <div className="flex gap-4">
            <a href="https://github.com" target="_blank" rel="noreferrer" className="p-2 border border-brand-border rounded-full text-brand-secondary hover:bg-brand-surface hover:text-brand-primary transition-colors">
              <Github size={20} />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="p-2 border border-brand-border rounded-full text-brand-secondary hover:bg-brand-surface hover:text-brand-primary transition-colors">
              <Linkedin size={20} />
            </a>
            <a href="https://notion.so/your-profile" target="_blank" rel="noreferrer" className="w-9 h-9 border border-brand-border rounded-full text-brand-secondary hover:bg-brand-surface hover:text-brand-primary transition-colors flex items-center justify-center font-black text-sm" title="Notion">
              N
            </a>
          </div>
          ...
          >
            ...
            >
              <div className="p-6 border-b border-brand-border flex justify-between items-center bg-white sticky top-0 z-10">
                <div>
                  <h3 className="text-2xl font-black tracking-tighter">{selectedProject.title}</h3>
                  <p className="text-brand-secondary text-sm font-medium">{selectedProject.subtitle}</p>
                </div>
                <button 
                  onClick={() => setSelectedProject(null)}
              ...
              <div className="overflow-y-auto p-6 md:p-10 no-scrollbar">
                <div className={`grid gap-8 ${selectedProject.category === 'App' ? 'grid-cols-2 md:grid-cols-3 lg:grid-cols-4' : 'grid-cols-1'}`}>
                  {selectedProject.images?.map((img: string, i: number) => (
                    <div key={i} className="space-y-2">
                      ...
                      <p className="text-[10px] font-bold text-brand-secondary uppercase tracking-widest text-center">
                        {selectedProject.category === 'App' ? `Screen ${i + 1}` : `Dashboard View ${i + 1}`}
                      </p>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-12 p-8 bg-brand-surface rounded-3xl">
                  <h4 className="text-sm font-black uppercase tracking-widest mb-4">{t.projects.impact}</h4>
                  <ul className="grid md:grid-cols-2 gap-4">
                    {selectedProject.achievements.map((item: string, i: number) => (
                      <li key={i} className="flex gap-3 items-start">
                        <CheckCircle2 size={16} className="text-brand-accent mt-0.5" />
                        <p className="text-sm font-medium text-brand-secondary leading-relaxed">{item}</p>
                      </li>
                    ))}
                  </ul>
                </div>
...
function StatItem({ label, value, subValue, desc, color = "text-white", subValueColor = "bg-brand-accent/20 text-brand-accent" }: { label: string, value: string, subValue: string, desc: string, color?: string, subValueColor?: string }) {
  return (
    <motion.div 
      whileHover={{ y: -5 }}
      className="flex flex-col"
    >
      <span className="text-xs font-bold text-white/50 uppercase tracking-widest mb-2">{label}</span>
      <span className={`text-5xl font-black tracking-tighter mb-1 ${color}`}>{value}</span>
      <div className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold w-fit mb-4 ${subValueColor}`}>
        {subValue}
      </div>
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2">
        {items.map((item, i) => (
          <motion.span 
            key={item} 
            initial={{ backgroundColor: "rgba(248, 249, 250, 1)", color: "rgba(108, 117, 125, 1)", scale: 1 }}
            whileInView={{ 
              backgroundColor: ["rgba(248, 249, 250, 1)", "rgba(226, 232, 240, 1)", "rgba(255, 255, 255, 1)", "rgba(226, 232, 240, 1)", "rgba(248, 249, 250, 1)"],
              color: ["rgba(108, 117, 125, 1)", "rgba(15, 23, 42, 1)", "rgba(0, 0, 0, 1)", "rgba(15, 23, 42, 1)", "rgba(108, 117, 125, 1)"],
              ...
              borderColor: ["rgba(222, 226, 230, 1)", "rgba(255, 255, 255, 1)", "rgba(255, 255, 255, 1)", "rgba(255, 255, 255, 1)", "rgba(222, 226, 230, 1)"]
            }}
          ...
          >
            <motion.div 
              ...
              whileInView={{ x: "250%" }}
              transition={{ duration: 1.2, delay: i * 0.15, repeat: Infinity, repeatDelay: 4.8, ease: "linear" }}
...
function ProjectCard({ project, t, onViewDetails }: { project: any, t: any, onViewDetails: (p: any) => void }) {
  return (
    <div className="h-full flex flex-col bg-white border border-brand-border rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 group/card">
      <div className={`p-8 ${project.color} border-b border-brand-border flex justify-between items-start`}>
        <div>
          ...
          <p className="text-brand-secondary font-bold text-sm mb-4">{project.subtitle}</p>
          <div className="flex flex-wrap gap-2">
            {project.tags.map((tag: string) => (
              <span key={tag} className="text-[9px] font-black uppercase tracking-widest px-2 py-1 bg-brand-primary text-white rounded">
                {tag}
              </span>
            ))}
          </div>
        ...
        <ul className="space-y-4 flex-grow">
          {project.achievements.map((item: string, i: number) => (
            <li key={i} className="flex gap-3 items-start">
              ...
              <p className="text-brand-secondary leading-relaxed text-sm font-medium">{item}</p>
            </li>
          ))}
        </ul>
        <div className="mt-8 pt-6 border-t border-brand-border flex justify-between items-center">
          <span className="text-[10px] font-bold text-brand-accent uppercase tracking-widest">{project.category}</span>
...
function MindsetItem({ icon, title, desc }: { icon: React.ReactNode, title: string, desc: string }) {
  return (
    <div className="p-8 border border-brand-border rounded-3xl hover:bg-brand-surface transition-colors h-full flex flex-col">
      ...
      <p className="text-brand-secondary leading-relaxed text-sm flex-grow">{desc}</p>
    </div>
  );
}
...
function ExperienceItem({ company, role, period, desc }: { company: string, role: string, period: string, desc: string }) {
  return (
    <div className="relative pl-8 border-l border-white/10">
      ...
      <span className="text-xs font-bold text-brand-accent uppercase tracking-widest mb-2 block">{period}</span>
